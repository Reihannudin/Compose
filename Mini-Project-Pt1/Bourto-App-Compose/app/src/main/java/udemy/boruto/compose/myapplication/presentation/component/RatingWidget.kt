...
import udemy.boruto.compose.myapplication.ui.theme.EXTRA_LARGE_PADDING
import udemy.boruto.compose.myapplication.ui.theme.EXTRA_SMALL_PADDING
import udemy.boruto.compose.myapplication.ui.theme.StarColor
...
fun CalculateStars(rating : Double) : Map<String,Int>{
    ...
    LaunchedEffect(key1 = rating){
        ...
        if(firstNumber in 0..5 && lastNumber in 0..9){
            ...
            Log.d("RatingWidget","Invailid rating numbe.")
        }
    }
...
fun EmpetyFilledStarPreview(){
    ...
    EmpetyStar(starPath = starPath, starPathBounds = starPathBounds, scaleFactor = 2f )
}